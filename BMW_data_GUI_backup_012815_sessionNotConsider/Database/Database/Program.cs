...
namespace EEGDatabase
{
    public class Database
    {
        ...
        public void EEG_Insert(String UserName, double AF3,  double F7 ,  double F3, double FC5,  double T7, double P7, double O1,  double O2, double P8 , double T8, double FC6, double F4, double F8, double AF4, double TimeStamp, int section,  String ComputerTime )
        {
            // We use these three SQLite objects:
            SQLiteConnection sqlite_conn;
            SQLiteCommand sqlite_cmd;
        ...
        public void BandPowerInsert(String UserName,double Alpha , double Beta, double TimeStamp, int section, String ComputerTime)
        {
            // We use these three SQLite objects:
            SQLiteConnection sqlite_conn;
            SQLiteCommand sqlite_cmd;
        ...
        public void Loa_EEGData(String User )
        {
